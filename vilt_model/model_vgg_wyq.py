...
class VilT_Classification(nn.Module):
    ...
    def forward(self, img):
        ...
        embed = self.module1(img)  ##[16,3,384,384] #clo_token[16,x,768] jump to 196 line
...
class classifier(nn.Module):
    def __init__(self, hidden_size,se_dim):
        super().__init__()
        self.dense1 = nn.Linear(60, 1)  #msrvtt 64,x,1 activitynet 64,
#         # 64 768 x->64 768 1  error :1920*768and 30*1
        self.dense2 = nn.Linear(hidden_size, 200)  # 64 1 768->64 1 20个类
...
#            )
       # else:
        ...
        #         - - - - - - - - img and text embedding have been generated
        #         ----------------------------------------------image----------------------------------------------------------------
...
#         ipdb.set_trace()
        ...
        #    torch.full_like(image_masks, image_token_type_idx))  # 64 145 768

        #x = image_embeds  #embedding后的向量，然后经过一个Block模块进行分类
