...
def get_config():
    ...
    num_gpus = 1
    num_nodes = 1
    load_path = r"/mnt/weights/model_best-cvm.pt" 
#     load_path = r"/mnt/weights/model_best-Copy1.pt" #复现vitmodel_best-cvm.pt
#     load_path = r"/mnt/weights/imagenet21k+imagenet2012_ViT-B_16-224.pth" #复现vit
#     load_path = r"/mnt/weights/vilt_200k_mlm_itm.ckpt"
#     load_path=r"/mnt/weights/"
# #     load_path = r"/mnt/weights/model_final.pt"
#     load_path = r"/mnt/weights/VILT_attentionV_activitynet_best_model.pt"
#     load_path = r"/mnt/weights/GRU_attentionV_activitynet_best_model_final.pt"
#     load_path = r"/mnt/weights/VILT_attentionV_msrvtt_best_model.pt"
#     load_path = r"/mnt/weights/GRU_attentionV_msrvtt_best_model.pt"
