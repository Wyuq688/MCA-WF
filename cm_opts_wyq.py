...
def opt_algorithm():
    ...
    # path setting
    parser.add_argument('--result_path', type=str, default='/mnt/2023cvm/vilt-modal-attention(P+V+S)', help='path to the folder to save results')
#vilt-sig-modal-attention(S)
    # experiment controls
    # img -> 1
    # ingredient -> 2
    # final network -> 3
    ...
    parser.add_argument('--img_net', type=str, default='vilt',
    ...
    parser.add_argument('--word_net', type=str, default='vilt',
                        help='choose network backbone for ingredient channel: gru, vilt')
    ...
    parser.add_argument('--lr_m2', type=float, default=1e-2, help='learning rate for module 2')
    parser.add_argument('--lr_finetune', type=float, default=5e-5, help='fine-tune learning rate')
    parser.add_argument('--lrd_rate', type=float, default=0.1, help='decay rate of learning rate') #学习率降低的速率
    ...
    parser.add_argument('--beta_clip_align', type=float, default=0.01,
                        help='coefficient of kl loss between image features and word features')
    parser.add_argument('--beta_align', type=float, default=0.1,
                        help='coefficient of  l2norm loss between image features and word features')
    ...
    parser.add_argument('--beta_soft', type=float, default=0,
                        help='soft factor for class adj, from 0.0~1.0, the larger, the softer')
    ...
    parser.add_argument('--gcn_threshold', type=float, default=0.4,
                        help='the bigger, the more different from exist tage realations, range from [0,0.5]')
    ...
    parser.add_argument('--test_only', type=bool, default=True, help='test only')
